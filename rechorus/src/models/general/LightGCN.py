...
class LightGCNCPR(CPRModel, LightGCNBase):
	extra_log_args = ['emb_size', 'n_layers', 'batch_size', 'dyn_sample_rate', 'choose_rate', 'k_samples']
	...
	def forward(self, feed_dict):
		...
		user_embed, pos_item_embed = self.encoder(user, pos_items)	# [batch_size * dyn_sample_rate, k_samples, emb_size]
